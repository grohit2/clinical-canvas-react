      ...
      <div className="p-4 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {urgentAlerts.length} tasks require immediate attention (≤10
                min)
              </p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          {urgentAlerts.map((alert) => (
            <Card
              key={alert.id}
              className="p-4 border-l-4 border-urgent bg-urgent/5"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center gap-4 text-xs">
                    ...
                    <div
                      className={`font-medium ${getMinutesColor(alert.minutesLeft)}`}
                    >
        ...
        {urgentAlerts.length === 0 && !isLoading && (
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground">
              All critical tasks are on schedule.
            </p>
          </Card>
        )}
      </div>
