...
const mockUser = {
  ...
  professionalInfo: {
    ...
    workingHospital:
      "City General Hospital - Cardiac Wing, Building A, Floor 5",
    consultationFee: 1500,
    languages: ["English", "Hindi", "Spanish"],
    awards: ["Best Cardiac Surgeon 2022", "Excellence in Patient Care 2021"],
    research: [
      "Published 25+ research papers in cardiovascular surgery",
      "Lead researcher in minimally invasive cardiac procedures",
    ],
  },
  availability: {
    workingDays: [
    ...
    specialNotes:
      "Emergency surgeries take priority. Please allow buffer time between consultations.",
  },
  appointments: {
    upcoming: [
      {
          ...
          {mockUser.notifications.length === 0 && (
            <Card className="p-8 text-center">
              ...
              <p className="text-muted-foreground">
                All your patient tasks are up to date!
              </p>
            </Card>
          )}
        </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 min-h-[48px]">
                <span className="text-muted-foreground flex-shrink-0 w-32 sm:w-40">
                  Full Name
                </span>
                <div className="flex items-center gap-3 flex-1 justify-end">
                  <span className="font-medium text-right break-words max-w-[200px] sm:max-w-none">
                    {doctor.name}
                  </span>
              ...
              <Separator />
              <div className="flex items-center justify-between py-3 min-h-[48px]">
                <span className="text-muted-foreground flex-shrink-0 w-24 xs:w-28 sm:w-32 md:w-40">
                  Email ID
                </span>
                <div className="flex items-center gap-2 xs:gap-3 flex-1 justify-end overflow-hidden">
                  {isEditingEmail ? (
                    ...
                    <span className="font-medium text-right break-all text-xs xs:text-sm sm:text-base max-w-[120px] xs:max-w-[140px] sm:max-w-[180px] md:max-w-none">
                      {doctor.email}
                    </span>
                  )}
                  <Edit2
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3 min-h-[48px]">
                ...
                <div className="flex items-center gap-3 flex-1 justify-end">
                  ...
                  <Switch
                    checked={mockUser.securityInfo.twoFactorEnabled}
              ...
              <div className="flex items-center justify-between py-3 min-h-[48px]">
                ...
                <span className="font-medium text-right text-sm break-words max-w-[200px] sm:max-w-none">
                  {mockUser.securityInfo.lastLogin}
                </span>
              </div>
            </div>
          </Card>
