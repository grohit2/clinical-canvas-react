    ...
    <View style={styles.wrap}>
      <FlatList
        ...
        renderItem={({ item, index }) => {
          const isGeoTagCard = index === 0;
          const isCurrent = item.year === currentYear;
          return (
            <Pressable
              onPress={() => {
                if (isGeoTagCard && onCurrentYearAction) {
                  onCurrentYearAction();
                  return;
                }
              ...
              >
                {isGeoTagCard ? (
                  <View style={styles.geoTagCard}>
                    ...
                    <Text style={styles.geoTagTitle}>Geo Tag</Text>
                    <Text style={styles.geoTagSubTitle}>Capture geotagged photos</Text>
                  </View>
                ) : (
