...
function PatientListRow({ patient, taskCounts, onOpen, onPatientActions }) {
  ...
  return (
    <button className="pcard pcard-row navigable" onClick={onOpen}>
      ...
      <PatientNameLongPress patient={patient} onLongPress={onPatientActions} className="pcard-name">
