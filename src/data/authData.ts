...
export const doctorsDatabase: Doctor[] = [
  ...
  },
  {
    ...
    workingHospital:
      "City General Hospital - Emergency Department, Ground Floor",
    consultationFee: 1200,
    languages: ["English", "French"],
    awards: ["Outstanding Emergency Physician 2023", "Life Saver Award 2022"],
    research: [
      "Published 18+ research papers in emergency medicine",
      "Expert in trauma care protocols",
    ],
    gender: "Male",
  ...
  },
  {
    ...
    workingHospital:
      "City General Hospital - Internal Medicine, Building B, Floor 3",
    consultationFee: 1000,
    languages: ["English", "Chinese", "Spanish"],
    awards: [
      "Excellence in Diabetes Care 2023",
      "Research Innovation Award 2022",
    ],
    research: [
      "Published 15+ research papers in endocrinology",
