...
const MOCK_DATA: Item[] = [
  {
    type: "referral",
    id: "REF-10021",
    patient: { id: "P-001", name: "Anita Rao", uid: "MRN001" },
  ...
  },
  {
    type: "consult",
    id: "CONS-20011",
    patient: { id: "P-007", name: "Priya Desai", uid: "MRN007" },
  ...
  },
  {
    type: "referral",
    id: "REF-10022",
    patient: { id: "P-002", name: "Rajesh Kumar", uid: "MRN002" },
  ...
  },
  {
    type: "consult",
    id: "CONS-20012",
    patient: { id: "P-008", name: "Lakshmi Reddy", uid: "MRN008" },
  ...
  },
  {
    type: "referral",
    id: "REF-10023",
    patient: { id: "P-003", name: "Mohammed Ali", uid: "MRN003" },
    ...
    if (searchQuery.trim()) {
      ...
      items = items.filter((item) => {
        const patientMatch = item.patient.name.toLowerCase().includes(query) ||
          item.patient.uid?.toLowerCase().includes(query);
