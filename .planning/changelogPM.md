...
- Tasks top bar was simplified and aligned with other pages by removing undo/local-ledger messaging and using the standard header style.
- Task tables now collapse/expand directly from the table name for easier interaction.
- Each task table now has a 3-dot options menu to support table actions like sorting and upcoming controls.
- Top Add Task control on the task board was removed to reduce clutter while keeping add actions available in the lower area.
