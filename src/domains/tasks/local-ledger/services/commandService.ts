...
function toTaskCreateInput(
  ...
  return {
    ...
    doctorName: toNullableString(effectivePatch.doctorName),
    nurseName: toNullableString(effectivePatch.nurseName),
    taskType: toNullableString(effectivePatch.taskType),
    placeText: toNullableString(effectivePatch.placeText),
    recurrence: toNullableString(effectivePatch.recurrence),
    scheduleDay: toNullableString(effectivePatch.scheduleDay),
    scheduleTime: toNullableString(effectivePatch.scheduleTime),
    boardStatusLabel: toNullableString(effectivePatch.boardStatusLabel),
