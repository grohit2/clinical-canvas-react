...
export default function PatientDetail() {
  ...
  const [currentPatient, setCurrentPatient] = useState<PatientMeta | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-background pb-20 overflow-x-hidden">
        ...
        <div className="fixed top-16 left-0 right-0 z-40 bg-background/95 backdrop-blur-sm border-b shadow-sm">
          <div className="px-3 sm:px-4 lg:px-6 py-2">
            <div className="flex items-center justify-between">
              ...
              <StageChip
                stage={currentPatient.currentState}
                variant="caution"
                size="sm"
              />
            </div>
      ...
      <div
        className={`p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6 ${isScrolled ? "pt-20" : ""}`}
      >
        {/* Patient Hero */}
        <Card className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
            <div className="flex-1 min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-3 break-words">
                {currentPatient.name}
              </h1>
            ...
            <div className="mt-4 sm:mt-6 pt-4 border-t">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-2">
                <span className="font-medium break-words">
                  {demographics.emergencyContact.name}
                </span>
          ...
          <TabsContent value="overview" className="space-y-4 mt-6">
            <div className="space-y-4">
              ...
              {patientTimeline.length > 0 ? (
                <Timeline
                  entries={patientTimeline}
                  currentState={currentPatient.currentState}
                />
              ) : (
                <Card className="p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Card className="p-4 sm:p-6 border border-border/50">
                    ...
                    <p className="text-2xl sm:text-3xl font-bold text-primary mb-1">
                      ...
                      {demographics.lengthOfStay === 1 ? "day" : "days"}
                    </p>
                  ...
                  <Card className="p-4 sm:p-6 border border-border/50">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      {demographics.nextMilestoneTime}
                    </p>
                  </Card>
                </div>
              )}
